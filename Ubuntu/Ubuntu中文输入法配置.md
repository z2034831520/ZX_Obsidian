...
### 词库配置
修改完`UI`界面后我们还需要配置对应的词库，这样能提高我们的打字效率，首先我们需要去获得词库。这里我推荐使用维基百科提供的中文词库，我们可以在`GitHub`上下载词库[下载链接，点击直达](https://github.com/felixonmars/fcitx5-pinyin-zhwiki/releases)，在下载界面中我们选择文件类型为`.dict`的