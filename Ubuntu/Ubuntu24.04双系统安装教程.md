...
## 操作思路
在安装双系统之前我们需要明确自己的安装思路，首先你需要明白的一件事是：你的`Ubuntu`需要多大的硬盘空间？一般对于个人学习的话`200~300G`就够了，譬如我安装`Ubuntu`就是为了学习嵌入式的相关知识，核心内容是`ROS2`。当然我也会安装一些其它软件来感受一下`Linux`的软件生态，对于我个人来说`300G`就已经能够满足我的需求了，如果你有一些大型文件需要放到双系统中那么可以结合自己的实际场景进行调整，否则我就推荐
## 实操
