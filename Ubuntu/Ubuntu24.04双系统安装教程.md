...
![](assets/Ubuntu24.04双系统安装教程/file-20260808122823170.jpg)
...
![](assets/Ubuntu24.04双系统安装教程/file-20260808111432921.jpg)
...
结合上述内容如果你需要使用`Ubuntu`的休眠功能，那么交换分区的大小就和你的电脑物理内存大小保持一致即可，否者是不需要创建该分区的，因为系统会默认给你分配`8GB`的虚拟内存
## 实操
