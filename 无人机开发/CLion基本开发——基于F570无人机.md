...
![](assets/CLion基本开发——基于F570无人机/file-20260729150539671.png)
默认情况下大家可能没有下面的`ST-LINK`选项，如果没有的话可以进行快速的配置，点击下面的编辑调试服务器即可进行配置，在新界面中点击加号，然后选择`ST-LINK`即可
![](assets/CLion基本开发——基于F570无人机/file-20260729150705911.png)
具体的参数配置可以参照图中的内容，配置完成之后即可点击绿色的下载烧录按键进行下载烧录
![](assets/CLion基本开发——基于F570无人机/file-20260729150932143.png)
...
![](assets/CLion基本开发——基于F570无人机/file-20260729151442692.png)
在插件界面中我们在搜索框中输入`serial port`然后下载红色方框内的插件即可
![](assets/CLion基本开发——基于F570无人机/file-20260729151538841.png)
下载完成之后我们可以点击顶部栏中的视图选项，然后选择工具视图，在工具视图中选择串行连接
![](assets/CLion基本开发——基于F570无人机/file-20260729152112840.png)